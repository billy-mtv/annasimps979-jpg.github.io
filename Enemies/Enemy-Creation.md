...
*  An enemy's _elemental type_ determines the damage that different elemental attacks do to them, and is explained in more detail in the [Elemental Types](../Combat-Rules/Elemental-Types) section.
